...
OUTFOLDER = '/shared/tale2/Shared/szhou/ICML2019/data/openfmri/'
# CONTRAST_DICT = {'ds007':{'task003': [6, 7]},
#                'ds008':{'task002': [8, 10]},
#                'ds101':{'task001': [7, 8]},
#                'ds102':{'task001': [7, 8]}}
CONDITION_DICT = {'ds007': {'task003': [2, 3]},
                  'ds008': {'task002': [3, 4]},
                  'ds101': {'task001': [1, 2, 3, 4]},
                  'ds102': {'task001': [1, 2, 3, 4]}}
                ...
                for run in [1, 2]:
                    ...
                    if os.path.exists(feat_folder):
                        for cond in CONDITION_DICT[ds][task]:
                            img_target = '%szstats2/%s_%s_c%s_%s.nii.gz'%(OUTFOLDER, ds, sub_folder, cond, run)
